...
import LinkedinIcon from '../commons/icons/LinkedinIcon.vue'
import GithubIcon from '../commons/icons/GithubIcon.vue'
import InstagramIcon from '../commons/icons/InstagramIcon.vue'
